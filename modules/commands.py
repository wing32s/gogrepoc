...
def cmd_update(os_list, lang_list, skipknown, updateonly, partial, ids, skipids, skipHidden, 
               installers, resumemode, strict, strictDupe, md5xmls, noChangeLogs):
    """Update the local game manifest using the modular architecture.
    
    This implementation uses the game_filter and update modules for cleaner,
    more maintainable code while preserving the existing update behavior.
    ...
    info("Using modular update architecture")
    ...
    if needresume:
        ...
        if resumemode != 'onlyresume':
            ...
            cmd_update(save_os_list, save_lang_list, save_skipknown, save_updateonly,
